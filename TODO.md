...
- 已完成板端开机自启动编排：2K1000LA 托管 Mosquitto、云端桥接、视觉服务、Qt HMI；301 托管 `/home/root/main` 真实采集程序。
...
5. 赛前做一次断电/重启恢复测试，确认 systemd 服务自动拉起且不会出现重复 301 发布源。

## 下一步建议

1. P5：开机自启动已部署，下一步做断电/重启恢复验证。
